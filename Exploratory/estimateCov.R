...
## This is an exploratory analysis of effects of network smoothing in expression and estimating the empirical covariance matrix.
## Setting alpha = 0.3 with 3 rounds of smoothing seems OK.
