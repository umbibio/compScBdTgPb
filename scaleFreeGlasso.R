...
bd.in.Cov <- readRDS('../Input/compScBdTgPb/glasso/S_bd_smooth_gam_de_trended.RData')
bd.input.dir <- "../Input/compScBdTgPb/glasso/Bd_de_trended_out/"
bd.sc.tc.mus.scale <- readRDS('../Input/compScBdTgPb/RData/bd_sc_tc_mus_scale.RData')
bd.genes <- rownames(bd.in.Cov)
...
bd.L <- networksScaleFreeStats(bd.genes, bd.input.dir, bd.prod.desc)
tg.L <- networksScaleFreeStats(tg.genes, tg.input.dir, tg.prod.desc)

bd.opt.network <- genOptNetwork(bd.genes, bd.L$file.info, bd.L$networks, bd.prod.desc)
saveRDS(bd.opt.network, '../Input/compScBdTgPb/RData/bd_opt_net.RData')
...
bd.genes.clust <- bd.sc.tc.mus.scale %>% dplyr::select(GeneID, cluster, phase) %>% distinct()
bd.genes.clust$GeneID <- gsub('_', '-', bd.genes.clust$GeneID)
...
bd.clust.net.d <- rankedNetDeg(bd.clust.net, bd.prod.desc, bd.genes.clust)
saveRDS(bd.clust.net.d, '../Input/compScBdTgPb/RData/bd_clust_net_d.RData')
write.xlsx(bd.clust.net.d, '../Output/compScBdTgPb/tables/bd_genes_cyclic_network_nodes.xlsx')
...
bd.opt.net.d <- rankedNetDeg(bd.opt.network, bd.prod.desc, bd.genes.clust)
saveRDS(bd.opt.net.d, '../Input/compScBdTgPb/RData/bd_opt_net_d.RData')
write.xlsx(bd.opt.net.d, '../Output/compScBdTgPb/tables/bd_genes_opt_network_nodes.xlsx')
...
bd.e.l <- getEdgeList(bd.clust.net, bd.prod.desc)
saveRDS(bd.e.l, '../Input/compScBdTgPb/RData/bd_e_l.RData')
write.xlsx(bd.e.l, '../Output/compScBdTgPb/tables/bd_cyclic_network_edge_list.xlsx')
...
bd.opt.e.l <- getEdgeList(bd.opt.network, bd.prod.desc)
saveRDS(bd.opt.e.l, '../Input/compScBdTgPb/RData/bd_opt_e_l.RData')
write.xlsx(bd.e.l, '../Output/compScBdTgPb/tables/bd_opt_network_edge_list.xlsx')
