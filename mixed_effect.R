...
saveRDS(object = sync.tc.fits ,file = "../Input/compScBdTgPb/RData/bd_sme_fits_sync_tc_20min.RData")
...
saveRDS(object = sc.tc.fits, file = "../Input/compScBdTgPb/RData/bd_sme_fits_sc_tc_20min.RData")
...
pdf(file = "../Output/compScBdTgPb/figs/bd_sme_fits_sc.pdf",   # The directory you want to save the file in
...
pdf(file = "../Output/compScBdTgPb/figs/bd_sme_fits_sync.pdf",   # The directory you want to save the file in
    width = 10, # The width of the plot in inches
    height = 10) # The height of the plot in inches
