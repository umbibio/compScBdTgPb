...
bd.cell.cycle.genes.df <- readRDS('../Input/compScBdTgPb/RData/bd_cell_cycle_genes_df.RData')
bd.tc.logCPM <- readRDS('../Input/compScBdTgPb/RData/bd_sync_tc_logCPM.RData')
...
saveRDS(sync.tc.df, '../Input/compScBdTgPb/RData/bd_sync_tc_df.RData')

## Get the common genes
comm.genes <- unique(sync.tc.df$variable)[which(unique(sync.tc.df$variable) %in%
                                                  unique(sc.tc.df$variable))]

saveRDS(comm.genes, '../Input/compScBdTgPb/RData/bd_sync_sc_comm.genes.RData')
...
saveRDS(mu.sync.com.grid, '../Input/compScBdTgPb/RData/bd_mu_sync_com_grid.RData')
saveRDS(mu.sc.com.grid, '../Input/compScBdTgPb/RData/bd_mu_sc_com_grid.RData')
...
plot(p)  
ggsave(filename="../Output/compScBdTgPb/figs/bd_lag_time_dist.pdf",
       plot=p,
       width = 5, height = 4,
...
saveRDS(S.O.bd, '../Input/compScBdTgPb/RData/S.O.bd.RData')
...
saveRDS(pc.sds.adj, '../Input/compScBdTgPb/RData/bd_pc_sds_adj.RData')
...
plot(p)
ggsave(filename="../Output/compScBdTgPb/figs/aligned_pseudo_time_BD.pdf",
      plot=p,
      width = 5, height = 5,
      units = "in", # other options are "in", "cm", "mm"
      dpi = 300
...
saveRDS(bd.cell.cycle.genes.df.adj, '../Input/compScBdTgPb/RData/bd_cell_cycle_genes_df_adj.RData')
