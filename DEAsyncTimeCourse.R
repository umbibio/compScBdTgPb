...
count.file <-  "../Input/compScBdTgPb//timeCourse/raw_counts_normal_growth.xlsx"
expmnt.file <- "../Input/compScBdTgPb//timeCourse/experiment_design.xlsx"
...
saveRDS(tc.logCPM, '../Input/compScBdTgPb/tc_sync_logCPM.RData')
